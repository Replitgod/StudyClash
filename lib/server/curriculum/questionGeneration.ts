...
export async function generateQuestionsForConcept(args: {
  ...
  const prompt = `
You are writing exam-quality practice questions for AceDecks, grounded STRICTLY in the excerpts below. Never use outside knowledge, never invent facts not supported by these excerpts.
