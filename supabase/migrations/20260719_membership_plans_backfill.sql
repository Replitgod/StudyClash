...
values
  ('pro_individual', 'AceDecks Pro', null, 'Unlimited deck generation, full diagnostics, and every exam tunnel.'),
  ('exam_tunnel', 'AceDecks Pro', null, 'Legacy plan id, folded into AceDecks Pro -- kept resolvable for existing accounts.'),
