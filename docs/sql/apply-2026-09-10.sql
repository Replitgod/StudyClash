...
-- finds no matching exam simply inserts nothing -- no error, no questions,
-- and an exam that stays switched off for no visible reason.
--
-- 01 is independent of the other four: it adds the two columns that let a
-- processed course become a study deck.
--
-- Every statement is idempotent. Running this twice is safe.
--
-- Generated by scripts/build-sql-bundle-0910.mjs -- do not hand-edit.
