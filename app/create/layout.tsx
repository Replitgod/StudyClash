...
export const metadata: Metadata = {
  title: "Create Study Deck From Notes",
  description:
    "Upload notes or PDF and generate AI quiz battles instantly. StudyClash turns your material into practice questions with weak-topic feedback.",
  alternates: {
    canonical: "/create",
  },
  keywords: [
