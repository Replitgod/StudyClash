...
export const metadata: Metadata = {
  title: "Terms of Use | AceDecks",
  description: "Terms for using AceDecks public beta, including acceptable use and account responsibilities.",
  alternates: {
    canonical: "/terms",
  },
  openGraph: {
    title: "Terms of Use | AceDecks",
    description: "Terms and conditions for using AceDecks.",
    url: "/terms",
  ...
  twitter: {
    ...
    title: "Terms of Use | AceDecks",
    description: "Read AceDecks terms for beta usage and account responsibilities.",
      ...
      <Reveal className="mx-auto w-full max-w-3xl rounded-2xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-sm sm:p-8">
        ...
        <div className="mt-6 space-y-5 text-sm leading-relaxed text-white/80">
          <section>
            ...
            <p className="mt-1">AceDecks is provided for educational use. Do not misuse the app, automate abuse, or attempt to bypass usage limits.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-1">AceDecks is a study tool. We do not guarantee exam scores or academic results.</p>
          </section>

          <section>
            <h2 className="text-base font-bold text-white">Questions</h2>
            <p className="mt-1">Need help with these terms? <Link href="/contact" className="text-indigo-200 hover:text-indigo-100">Contact us</Link>.</p>
          </section>
        </div>
      </Reveal>
    </main>
