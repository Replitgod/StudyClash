...
export const metadata: Metadata = {
  title: "Terms of Use | StudyJoust",
  description: "Terms for using StudyJoust public beta, including acceptable use and account responsibilities.",
  alternates: {
    canonical: "/terms",
  },
  openGraph: {
    title: "Terms of Use | StudyJoust",
    description: "Terms and conditions for using StudyJoust.",
    url: "/terms",
  ...
  twitter: {
    ...
    title: "Terms of Use | StudyJoust",
    description: "Read StudyJoust terms for beta usage and account responsibilities.",
  ...
  return (
    <main className={`relative min-h-dvh w-full overflow-x-hidden bg-[#05050a] px-4 pt-12 text-white sm:px-6 sm:pt-16 ${FLOATING_ACTION.mobileBottomPadding}`}>
      <Reveal className="mx-auto w-full max-w-3xl rounded-2xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-sm sm:p-8">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-fuchsia-300">StudyJoust Public Beta</p>
        ...
        <div className="mt-6 space-y-5 text-sm leading-relaxed text-white/80">
          <section>
            ...
            <p className="mt-1">StudyJoust is provided for educational use. Do not misuse the app, automate abuse, or attempt to bypass usage limits.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-1">StudyJoust is a study tool. We do not guarantee exam scores or academic results.</p>
          </section>
